...
export async function diceOracleDialog() {
...
`;
  ...
  await rollOracle(data);
}

async function rollOracle({ oracleType, modifier, rollMode, question }) {
...
<div class="uvg-oracle-result">
  ...
  <div class="oracle-roll">
    <p><strong>${$l10n('SDM.PowerRollFormulaAbbr')}:</strong> ${formula.replaceAll('[sdm-oracle]', '')} = ${roll.total}</p>
