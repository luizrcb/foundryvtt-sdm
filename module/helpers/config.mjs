...
SDM.itemPropertiesToActiveEffects = [
  'system.area.value',
  'system.armor.type',
  'system.armor.value',
  'system.capacity.max',
  ...
  'system.cost',
  'system.cure_steps.completed',
  'system.cure_steps.required',
  'system.default_ability',
  'system.description',
  'system.features',
  'system.flare.value',
  'system.is_hallmark',
  'system.is_supply',
  'system.max_powers',
  'system.packed_remaining_items',
  'system.pocket.value',
  'system.power.default_ability',
  'system.power.description',
  'system.power.duration',
  'system.power.img',
  'system.power.is_dangerous',
  'system.power.level',
  'system.power.name',
  'system.power.overcharge_roll_formula',
  'system.power.overcharge',
  'system.power.range',
  'system.power.roll_formula',
  'system.power.target',
  'system.powers_current_index',
  'system.quantity',
  'system.range.value',
  'system.replenish.value',
  'system.resistant.value',
  'system.resources',
  'system.size.unit',
  'system.size.value',
  'system.slots_override',
  'system.starting_kit',
  'system.status',
  'system.supply_type',
  'system.ward.type',
  'system.ward.value',
  'system.weapon.damage.base',
  'system.weapon.damage.bonus',
...
SDM.itemModType = {
  armor_ward: 'SDM.ItemMod.ArmorWard',
  augment: 'SDM.ItemMod.Augment',
  container: 'SDM.ItemMod.Container',
  gear: 'SDM.ItemMod.Gear',
  power_album: 'SDM.ItemMod.PowerAlbum',
  weapon: 'SDM.ItemMod.Weapon'
};
...
SDM.baseFeatures = [
  ...
  { value: 'range', label: 'SDM.ItemFeature.range' },
];
...
SDM.armorFeatures = [
  ...
  { value: 'ward', label: 'SDM.ItemFeature.ward' },
  { value: 'weapon', label: 'SDM.ItemFeature.weapon' }
];
